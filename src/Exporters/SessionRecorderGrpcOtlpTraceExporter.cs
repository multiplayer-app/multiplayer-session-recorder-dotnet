...
/// <summary>
/// gRPC OTLP trace exporter that filters spans by SessionRecorder trace ID prefixes.
/// </summary>
public class SessionRecorderGrpcOtlpTraceExporter : BaseExporter<Activity>
{
    private readonly OtlpTraceExporter _innerExporter;
    private readonly string _apiKey;
    
    /// <summary>
    /// Initializes a new instance of the SessionRecorderGrpcOtlpTraceExporter class.
    /// </summary>
    /// <param name="apiKey">The API key for authorization header.</param>
    /// <param name="endpoint">The OTLP endpoint URL.</param>
    public SessionRecorderGrpcOtlpTraceExporter(string? apiKey = null, string? endpoint = null)
    {
        _apiKey = apiKey ?? string.Empty;
        
        var options = new OtlpExporterOptions
        {
            Endpoint = new Uri(endpoint ?? SessionRecorderExporterEndpoint.GrpcTracesEndpoint),
