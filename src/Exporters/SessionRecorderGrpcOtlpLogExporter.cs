...
/// <summary>
/// gRPC OTLP log exporter that filters log records by SessionRecorder trace ID prefixes.
/// </summary>
public class SessionRecorderGrpcOtlpLogExporter : BaseExporter<LogRecord>
{
    private readonly OtlpLogExporter _innerExporter;
    private readonly string _apiKey;
    
    /// <summary>
    /// Initializes a new instance of the SessionRecorderGrpcOtlpLogExporter class.
    /// </summary>
    /// <param name="apiKey">The API key for authorization header.</param>
    /// <param name="endpoint">The OTLP endpoint URL.</param>
    public SessionRecorderGrpcOtlpLogExporter(string? apiKey = null, string? endpoint = null)
    {
        _apiKey = apiKey ?? string.Empty;
        
        var options = new OtlpExporterOptions
        {
            Endpoint = new Uri(endpoint ?? SessionRecorderExporterEndpoint.GrpcLogsEndpoint),
