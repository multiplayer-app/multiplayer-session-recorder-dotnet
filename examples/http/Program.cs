...
Console.WriteLine($"OTLP_TRACES_ENDPOINT: {Config.OTLP_TRACES_ENDPOINT}");
...
// Configure HTTP Capture Options for SessionRecorderHttpCaptureMiddleware
...
// Add SessionRecorder HTTP Capture Middleware
